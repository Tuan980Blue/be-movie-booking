        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDiscountMinor = table.Column<int>(type: "integer", nullable: true),
                    MinOrderMinor = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    TotalAmountMinor = table.Column<int>(type: "integer", nullable: false),
                    Currency = table.Column<string>(type: "text", nullable: false),
                    CustomerContactJson = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtitle = table.Column<bool>(type: "boolean", nullable: false),
                    Format = table.Column<int>(type: "integer", nullable: false),
                    BasePriceMinor = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyUrl = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatPriceMinor = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketQr = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItems_ShowtimeId_SeatId",
                table: "BookingItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceRules_CinemaId_DayType_SeatType",
                table: "PriceRules",
                columns: new[] { "CinemaId", "DayType", "SeatType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PriceRules_DayType_SeatType",
                table: "PriceRules",
                columns: new[] { "DayType", "SeatType" },
                unique: true,
                filter: "\"CinemaId\" IS NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_CinemaId_Code",
                table: "Rooms",
                columns: new[] { "CinemaId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Seats_RoomId_RowLabel_SeatNumber",
                table: "Seats",
                columns: new[] { "RoomId", "RowLabel", "SeatNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Showtimes_MovieId_StartUtc",
                table: "Showtimes",
                columns: new[] { "MovieId", "StartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Showtimes_RoomId_StartUtc",
                table: "Showtimes",
